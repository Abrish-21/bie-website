...
export default function BusinessPulsePage() {
  ...
  const newsFeedItems = [
    ...
    },
    {
      ...
      thumbnail: "https://images.unsplash.com/photo-1742996111692-2d924f12a058?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxldGhpb3BpYSUyMGJ1c2luZXNzJTIwbWVldGluZ3xlbnwxfHx8fDE3NTU2NDQ2Mjh8MA&ixlib=rb-4.1.0&q=80&w=1080",
    ...
    },
    {
      ...
      thumbnail: "https://images.unsplash.com/photo-1746037870491-b2e415517d0f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzdG9jayUyMG1hcmtldCUyMHRyYWRpbmclMjBmbG9vcnxlbnwxfHx8fDE3NTU2NDY4NzB8MA&ixlib=rb-4.1.0&q=80&w=1080",
      timestamp: "1 day ago",
      isLive: false
    }
  ];
  ...
  const opportunities = [
    ...
    },
    {
      ...
      value: "$1.2B",
      deadline: "Oct 1, 2025",
      imageUrl: "https://images.unsplash.com/photo-1741991110666-88115e724741?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxldGhpb3BpYSUyMGJ1c2luZXNzJTIwc2t5bGluZXxlbnwxfHx8fDE3NTU2NDY4Njd8MA&ixlib=rb-4.1.0&q=80&w=1080",
      isSponsored: true
    },
    {
    ...
    },
    {
      ...
      imageUrl: "https://images.unsplash.com/photo-1557804500-7a58fbcd4d1a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXNpbmVzcyUyMG1lZXRpbmclMjBjb25mZXJlbmNlfGVufDF8fHx8MTc1NTU2NTQ0NXww&ixlib=rb-4.1.0&q=80&w=1080",
      isSponsored: false
    }
  ];
            ...
            <section>
              ...
              <div className="space-y-4">
                {newsFeedItems.map((item, index) => (
                  <div key={index} className="flex items-start space-x-4 py-4 border-b border-gray-100 hover:bg-gray-50 transition-colors cursor-pointer">
              ...
              <div className="relative">
                <div className="flex space-x-6 overflow-x-auto pb-4 scrollbar-hide">
                  {opportunities.map((opportunity, index) => (
                    <Card key={index} className="flex-shrink-0 w-80 hover:shadow-lg transition-shadow border-0 shadow-md">
                ...
                <button className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 bg-white shadow-lg rounded-full p-2 hover:bg-gray-50">
                  <ChevronLeft className="h-5 w-5 text-gray-600" />
                </button>
                <button className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 bg-white shadow-lg rounded-full p-2 hover:bg-gray-50">
                  <ChevronRight className="h-5 w-5 text-gray-600" />
                </button>
              </div>
              
              {/* Mobile View: Stack vertically on mobile */}
